 ...
 */
public class PhoneFieldEditionManager extends MultipleFieldEditionManager {

    public PhoneFieldEditionManager() {
        super(R.drawable.ic_call_gray_24dp, R.string.phone);
    }

    protected PhoneFieldEditionManager(Parcel in) {
        super(in);
    }
    ...
    protected View getSubView(LayoutInflater inflater, ViewGroup container) {
        ...
        binding.edtTxtContent.setHint(R.string.phone);
