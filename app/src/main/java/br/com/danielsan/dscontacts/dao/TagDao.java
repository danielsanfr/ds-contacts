...
public class TagDao extends AbstractDao<Tag, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property FieldName = new Property(2, String.class, "fieldName", false, "FIELD_NAME");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TAG\" (" + //
                ...
                "\"FIELD_NAME\" TEXT NOT NULL );"); // 2: fieldName
    }
    ...
    protected void bindValues(SQLiteStatement stmt, Tag entity) {
        ...
        stmt.bindString(3, entity.getFieldName());
    }
    ...
    public Tag readEntity(Cursor cursor, int offset) {
        Tag entity = new Tag( //
            ...
            cursor.getString(offset + 2) // fieldName
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Tag entity, int offset) {
        ...
        entity.setFieldName(cursor.getString(offset + 2));
     }
