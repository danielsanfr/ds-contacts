...
public class AddressDao extends AbstractDao<Address, Long> {
    ...
    */
    ...
    private Query<Address> contact_AddressListQuery;
    ...
    /** Internal query to resolve the "addressList" to-many relationship of Contact. */
    public List<Address> _queryContact_AddressList(long contactId) {
        synchronized (this) {
            if (contact_AddressListQuery == null) {
                QueryBuilder<Address> queryBuilder = queryBuilder();
                queryBuilder.where(Properties.ContactId.eq(null));
                contact_AddressListQuery = queryBuilder.build();
            }
        }
        Query<Address> query = contact_AddressListQuery.forCurrentThread();
