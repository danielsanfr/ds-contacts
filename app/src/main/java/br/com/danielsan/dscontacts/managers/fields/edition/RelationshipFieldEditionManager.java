 ...
 */
public class RelationshipFieldEditionManager extends MultipleFieldEditionManager {

    public RelationshipFieldEditionManager() {
        super(R.drawable.ic_people_gray_24dp, R.string.relationship);
    }

    protected RelationshipFieldEditionManager(Parcel in) {
        super(in);
    }
    ...
    protected View getSubView(LayoutInflater inflater, ViewGroup container) {
        ...
        binding.edtTxtContent.setHint(R.string.relationship);
